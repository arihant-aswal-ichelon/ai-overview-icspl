                                                    ...
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li class="dropdown-item">
                                                                <a href="{{ url('keyword-analysis/'.$client->id) }}" type="submit" class="btn btn-link " style="text-align:left; padding:0; border:none; background:none;">
                                                                    <i class="mdi_icon mdi mdi-graphql text-muted"></i> Keyword Analysis
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
