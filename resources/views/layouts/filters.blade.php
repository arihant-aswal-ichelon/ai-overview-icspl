...
<form method="post" action="">
    ...
    <div class="row align-items-center g-3">
        ...
        <div class="col-lg-4">
            ...
            <input type="text" class="form-control" value="<?php echo $lms_daterange; ?>" data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true" id="lms_daterange" name="lms_daterange" value="">
        </div> 
        <div class="col-lg-4">
            <label for="choices-multiple-remove-button" class="form-label text-muted">Select Date Range</label>
            <p class="text-muted">Set <code>updated date</code> filter.</p>
            <input type="text" class="form-control" value="<?php echo $lms_updateddaterange; ?>" data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true" id="lms_updateddaterange" name="lms_updateddaterange" value="">
        </div> 
